...
function gameStart() {
    ...
    for(i = 0; i < 9; i++) {
        ...
        document.getElementById(i.toString).style.color=colorArray[rngesus]; //changes color of circle
    ...
    //pick a random correct circle from circleID
    rngesus = Math.floor((Math.random() * 10)+1);
    var color = circleID[rngesus];
